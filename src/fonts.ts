...
// All glyphs in one font must share the same number of rows. Every timer style
// renders 5 rows. Blocky digits are 4 chars wide; digital digits are 5. Pixel
// stores 8x20 bitmaps.
//
// Examples of tweaks:
...
//
// To add a new font: add a digit map, a case in glyphRows(), then add its name
// to FONTS.
...
// ---------- pixel (8x20 bitmaps rendered as braille, 4 cols x 5 rows) ----------

export const pixelDigits: Record<string, string[]> = {
  '0': [
    '00111100', '00111100', '01000010', '10000011', '10000011', '10000101',
    '10000101', '10001001', '10010001', '10010001', '10100001', '10100001',
    '11000001', '10000001', '10000001', '10000001', '10000001', '01000010',
    '00111100', '00111100',
  ],
  '1': [
    '00110000', '00110000', '01110000', '00010000', '00010000', '00010000',
    '00010000', '00010000', '00010000', '00010000', '00010000', '00010000',
    '00010000', '00010000', '00010000', '00010000', '00010000', '00110000',
    '01111000', '01111000',
  ],
  '2': [
    '00111100', '00111100', '01000010', '00000010', '00000010', '00000010',
    '00000010', '00000100', '00001000', '00001000', '00010000', '00010000',
    '00100000', '01000000', '01000000', '10000000', '10000000', '10000000',
    '11111111', '11111111',
  ],
  '3': [
    '00111100', '00111100', '01000010', '00000010', '00000010', '00000010',
    '00000010', '00111100', '00000010', '00000010', '00000010', '00000010',
    '00000010', '00000010', '00000010', '01000010', '01000010', '00111100',
    '00000000', '00000000',
  ],
  '4': [
    '00011000', '00011000', '00111000', '01101000', '01101000', '11001000',
    '11001000', '10001000', '10001000', '10001000', '11111111', '11111111',
    '00001000', '00001000', '00001000', '00001000', '00001000', '00001000',
    '00001000', '00001000',
  ],
  '5': [
    '11111111', '11111111', '10000000', '10000000', '10000000', '11111110',
    '11111110', '00000010', '00000010', '00000010', '00000010', '00000010',
    '00000010', '00000010', '00000010', '01000010', '01000010', '00111100',
    '00000000', '00000000',
  ],
  '6': [
    '00111100', '00111100', '01000010', '10000000', '10000000', '10000000',
    '10000000', '11111110', '10000010', '10000010', '10000010', '10000010',
    '10000010', '10000010', '10000010', '10000010', '10000010', '01000010',
    '00111100', '00111100',
  ],
  '7': [
    '11111111', '11111111', '00000010', '00000010', '00000010', '00000100',
    '00000100', '00000100', '00001000', '00001000', '00001000', '00001000',
    '00010000', '00010000', '00010000', '00100000', '00100000', '00100000',
    '01000000', '01000000',
  ],
  '8': [
    '00111100', '00111100', '01000010', '10000001', '10000001', '10000001',
    '10000001', '00111100', '01000010', '01000010', '10000001', '10000001',
    '10000001', '10000001', '10000001', '10000001', '10000001', '01000010',
    '00111100', '00111100',
  ],
  '9': [
    '00111100', '00111100', '01000010', '10000001', '10000001', '10000001',
    '10000001', '01111110', '00000010', '00000010', '00000010', '00000010',
    '00000010', '00000010', '00000010', '01000010', '01000010', '00111100',
    '00000000', '00000000',
  ],
  ':': [
    '00', '00', '00', '01', '01', '01', '01', '00', '00', '00',
    '00', '00', '01', '01', '01', '00', '00', '00', '00', '00',
  ],
};
...
export function timerFontHeight(font: TimerFont): number {
  return glyphRows('0', font).length;
}
